...
/**
 * The idea of this class is to test if the Sun's implementation multistep image scaling (using
 * either RenderingHints.VALUE_INTERPOLATION_BICUBIC or RenderingHints.VALUE_INTERPOLATION_BILINEAR)
 */
public class ImprovedMultistepRescaleOp extends AdvancedResizeOp {
  ...
  public ImprovedMultistepRescaleOp(
      int dstWidth, int dstHeight, Object renderingHintInterpolation) {
    this(
        DimensionConstrain.createAbsolutionDimension(dstWidth, dstHeight),
