...
/**
 * A filter which performs a "smart blur". i.e. a blur which blurs smotth parts of the image while
 * preserving edges.
 */
public class SmartBlurFilter extends AbstractBufferedImageOp {
  ...
  private void thresholdBlur(
      Kernel kernel, int[] inPixels, int[] outPixels, int width, int height, boolean alpha) {
    int index = 0;
