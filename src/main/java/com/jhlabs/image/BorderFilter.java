...
/**
 * A filter to add a border around an image using the supplied Paint, which may be null for no
 * painting.
 */
public class BorderFilter extends AbstractBufferedImageOp {
   ...
   */
  public BorderFilter(
      int leftBorder, int topBorder, int rightBorder, int bottomBorder, Paint borderPaint) {
