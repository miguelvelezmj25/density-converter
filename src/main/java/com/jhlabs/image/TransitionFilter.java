...
/**
 * A filter which uses another filter to perform a transition. e.g. to create a blur transition, you
 * could write: new TransitionFilter( new BoxBlurFilter(), "radius", 0, 100 );
 */
public class TransitionFilter extends AbstractBufferedImageOp {
  ...
  */
  ...
  /**
   * Prepare the filter for the transiton at a given time. The default implementation sets the given
   * filter property, but you could override this method to make other changes.
   *
  ...
  public BufferedImage filter(BufferedImage src, BufferedImage dst) {
    ...
    if (destination == null) return dst;
