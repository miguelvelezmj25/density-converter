...
/**
 * A filter to change the saturation of an image. This works by calculating a grayscale version of
 * the image and then extrapolating away from it.
 */
public class SaturationFilter extends PointFilter {
  ...
  /**
   * Set the amount of saturation change. 1 leaves the image unchanged, values between 0 and 1
   * desaturate, 0 completely desaturates it and values above 1 increase the saturation.
   *
