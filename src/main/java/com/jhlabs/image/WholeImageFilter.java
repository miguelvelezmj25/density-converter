...
/**
 * A filter which acts as a superclass for filters which need to have the whole image in memory to
 * do their stuff.
 */
public abstract class WholeImageFilter extends AbstractBufferedImageOp {
   ...
   */
  protected abstract int[] filterPixels(
      int width, int height, int[] inPixels, Rectangle transformedSpace);
}
