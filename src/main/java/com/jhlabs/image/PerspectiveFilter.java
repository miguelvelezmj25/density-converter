...
/**
 * A filter which performs a perspective distortion on an image. Coordinates are treated as if the
 * image was a unit square, i.e. the bottom-right corner of the image is at (1, 1). The filter maps
 * the unit square onto an arbitrary convex quadrilateral or vice versa.
 */
public class PerspectiveFilter extends TransformFilter {
  ...
  /**
   * Set the new positions of the image corners. This is the same as unitSquareToQuad, but the
   * coordinates are in image pixels, not relative to the unit square. This method is provided as a
   * convenience.
   *
   * @param x0 the new position of the top left corner
   * @param y0 the new position of the top left corner
  ...
  /**
   * Set the transform to map the unit square onto a quadrilateral. When filtering, all coordinates
   * will be scaled by the size of the image.
   *
   * @param x0 the new position of the top left corner
   * @param y0 the new position of the top left corner
   * @param x1 the new position of the top right corner
  ...
  /**
   * Set the transform to map a quadrilateral onto the unit square. When filtering, all coordinates
   * will be scaled by the size of the image.
   *
  ...
  public Rectangle2D getBounds2D(BufferedImage src) {
    if (clip) return new Rectangle(0, 0, src.getWidth(), src.getHeight());
