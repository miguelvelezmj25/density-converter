...
public class BicubicScaleFilter extends AbstractBufferedImageOp {
  ...
  /**
   * Constructor for a filter which scales the input image to the given width and height using
   * bicubic interpolation. Unfortunately, it appears that bicubic actually looks worse than
   * bilinear interpolation on most Java implementations, but you can be the judge.
   *
