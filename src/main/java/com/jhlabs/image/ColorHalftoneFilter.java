    ...
    for (int y = 0; y < height; y++) {
      ...
      for (int channel = 0; channel < 3; channel++) {
        ...
        for (int x = 0; x < width; x++) {
          ...
          // TODO: Efficiency warning: Because the dots overlap, we need to check neighbouring grid
          // squares.
          // We check all four neighbours, but in practice only one can ever overlap any given
          // point.
          for (int i = 0; i < 5; i++) {
