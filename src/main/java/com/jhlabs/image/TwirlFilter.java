...
/**
 * A Filter which distorts an image by twisting it from the centre out. The twisting is centred at
 * the centre of the image and extends out to the smallest of the width and height. Pixels outside
 * this radius are unaffected.
 */
public class TwirlFilter extends TransformFilter {
   ...
   *
   * @param angle the angle of twirl. This is the angle by which pixels at the nearest edge of the
   *     image will move.
   * @see #getAngle
   */
