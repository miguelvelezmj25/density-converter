...
/**
 * A filter which distorts an image by rippling it in the X or Y directions. The amplitude and
 * wavelength of rippling can be specified as well as whether pixels going off the edges are wrapped
 * or not.
 */
