...
/**
 * A filter which can be used to produce wipes by transferring the luma of a Destination image into
    ...
    for (int y = 0; y < height; y++) {
      ...
      for (int x = 0; x < width; x++) {
        ...
        if (Math.abs(hsb1[0] - hsb2[0]) < hTolerance
            ...
            && Math.abs(hsb1[2] - hsb2[2]) < bTolerance) inPixels[x] = rgb1 & 0xffffff;
