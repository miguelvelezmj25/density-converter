...
/**
 * A filter for warping images using the gridwarp algorithm. You need to supply two warp grids, one
 * for the source image and one for the destination image. The image will be warped so that a point
 * in the source grid moves to its counterpart in the destination grid.
 */
