 ...
 * override two methods to provide the mapping between source and destination pixels.
 */
public abstract class TransformFilter extends AbstractBufferedImageOp {
  ...
  /**
   * Clamp pixels RGB to the image edges, but zero the alpha. This prevents gray borders on your
   * image.
   */
