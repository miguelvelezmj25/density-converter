...
/**
 * A special Composite used for drawing "marching ants". It draws the ants at the 127 contour of the
 * alpha channel of the source. This can only be used on TYPE_INT_RGBA images.
 */
public final class ContourComposite implements Composite {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof ContourComposite)) return false;
    return true;
  }
}
