...
public enum ImageType {
  ...
  TIFF(
      ...
      ECompression.PNG,
      new String[] {"tif", "tiff"},
      true), // Tagged Image File Format
  BMP(
      ECompression.BMP,
      ECompression.PNG,
      new String[] {"bmp"},
      true); // bitmap image file or device independent bitmap (DIB)
  ...
  ImageType(
      ECompression outCompressionStrict,
      ECompression outCompressionCompat,
      String[] extensions,
      boolean supportRead) {
