...
public enum EScalingAlgorithm {
  LANCZOS1(
      new ResampleAlgorithm(new ResampleAlgorithm.LanczosFilter(1)),
      "lanczos1",
      new Type[] {Type.DOWNSCALING, Type.UPSCALING},
      false),
  LANCZOS2(
      new ResampleAlgorithm(new ResampleAlgorithm.LanczosFilter(2)),
      "lanczos2",
      new Type[] {Type.DOWNSCALING, Type.UPSCALING},
      true),
  LANCZOS3(
      new ResampleAlgorithm(new ResampleAlgorithm.LanczosFilter(3)),
      "lanczos3",
      new Type[] {Type.DOWNSCALING, Type.UPSCALING},
      true),
  LANCZOS4(
      new ResampleAlgorithm(new ResampleAlgorithm.LanczosFilter(4)),
      "lanczos4",
      new Type[] {Type.DOWNSCALING, Type.UPSCALING},
      false),
  LANCZOS5(
      new ResampleAlgorithm(new ResampleAlgorithm.LanczosFilter(5)),
      "lanczos5",
      new Type[] {Type.DOWNSCALING, Type.UPSCALING},
      false),
  MITCHELL(
      new ResampleAlgorithm(ResampleFilters.getMitchellFilter()),
      "mitchell",
      new Type[] {Type.DOWNSCALING, Type.UPSCALING},
      true),
  BSPLINE(
      new ResampleAlgorithm(ResampleFilters.getBSplineFilter()),
      "bspline",
      new Type[] {Type.DOWNSCALING, Type.UPSCALING},
      false),
  HERMITE(
      new ResampleAlgorithm(ResampleFilters.getHermiteFilter()),
      "hermite",
      new Type[] {Type.DOWNSCALING, Type.UPSCALING},
      false),
  NEAREST_NEIGHBOR(
      new NaiveGraphics2dAlgorithm(RenderingHints.VALUE_INTERPOLATION_NEAREST_NEIGHBOR),
      "nearestNeighbor",
      new Type[] {Type.DOWNSCALING, Type.UPSCALING},
      true),
  BILINEAR_PROGRESSIVE(
      new ProgressiveAlgorithm(ProgressiveAlgorithm.Type.NOBEL_BILINEAR),
      "bilinearProgressive",
      new Type[] {Type.DOWNSCALING},
      true),
  BICUBIC_PROGRESSIVE(
      new ProgressiveAlgorithm(ProgressiveAlgorithm.Type.NOBEL_BICUBUC),
      "bicubicProgressive",
      new Type[] {Type.DOWNSCALING},
      true),
  NEAREST_NEIGHBOR_PROGRESSIVE(
      new ProgressiveAlgorithm(ProgressiveAlgorithm.Type.NOBEL_NEAREST_NEIGHBOR),
      "nearestNeighborProgressive",
      new Type[] {Type.DOWNSCALING},
      false),
  BILINEAR_PROGRESSIVE2(
      new ProgressiveAlgorithm(ProgressiveAlgorithm.Type.THUMBNAILATOR_BILINEAR),
      "bilinearProgressive2",
      new Type[] {Type.DOWNSCALING},
      false),
  BICUBIC_PROGRESSIVE_SMOOTH(
      new ProgressiveAlgorithm(ProgressiveAlgorithm.Type.IMGSCALR_SEVENTH_STEP),
      "bicubicProgressiveSmooth",
      new Type[] {Type.DOWNSCALING},
      false),
  BILINEAR_LANCZOS2(
      new ProgressiveAlgorithm(ProgressiveAlgorithm.Type.PROGRESSIVE_BILINEAR_AND_LANCZOS3),
      "bilinearLanczos2",
      new Type[] {Type.DOWNSCALING},
      true),
  BILINEAR_LANCZOS3(
      ...
      false),
  BICUBIC(
      new NaiveGraphics2dAlgorithm(RenderingHints.VALUE_INTERPOLATION_BICUBIC),
      "bicubic",
      new Type[] {Type.UPSCALING},
      true),
  BILINEAR(
      new NaiveGraphics2dAlgorithm(RenderingHints.VALUE_INTERPOLATION_BILINEAR),
      "bilinear",
      new Type[] {Type.UPSCALING},
      true);
